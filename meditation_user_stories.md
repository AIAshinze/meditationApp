...
**As a** new user, **I want to** register by entering my username, email, and password, **so that** I can create an account.
...
**Title:** Login and Sign-Up Feedback
...
**Title:** Popular Meditations Display
...
**Title:** Exercise "Instructions" Section
...
**Title:** Add to Favorites Button on Detail Page
